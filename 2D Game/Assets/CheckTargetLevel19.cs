...
public class CheckTargetLevel19 : MonoBehaviour
{
    Vector3 endPos;
    ...
    public Animator ColorChangeIcon1, ColorChangeIcon2;
    ...
    void WinSequence()
    {
        ...
        if (ColorChangeIcon1 != null)
            ColorChangeIcon1.SetBool("Win", true);

        if (ColorChangeIcon2 != null)
            ColorChangeIcon2.SetBool("Win", true);
